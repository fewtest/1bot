...
#ki1 = LINETCR.LINE()
#ki1.login(token="FEW TOKEN")
#ki1.loginResult()

#ki2 = LINETCR.LINE()
#ki2.login(token="FEW TOKEN")
#ki2.loginResult()

#ki3 = LINETCR.LINE()
#ki3.login(token="FEW TOKEN")
#ki3.loginResult()

#ki4 = LINETCR.LINE()
#ki4.login(token="FEW TOKEN")
#ki4.loginResult()

#ki5 = LINETCR.LINE()
#ki5.login(token="FEW TOKEN")
#ki5.loginResult()

#ki6 = LINETCR.LINE()
#ki6.login(token="FEW TOKEN")
#ki6.loginResult()

#ki7 = LINETCR.LINE()
#ki7.login(token="FEW TOKEN")
#ki7.loginResult()

#ki8 = LINETCR.LINE()
#ki8.login(token="FEW TOKEN")
#ki8.loginResult()

#ki9 = LINETCR.LINE()
#ki9.login(token="FEW TOKEN")
#ki9.loginResult()

#ki10 = LINETCR.LINE()
#ki10.login(token="FEW TOKEN")
#ki10.loginResult()
...
║‣ /ขโมย [คำสั่งเชล ขโมย]
║‣ /สื่อ [คำสั่งเชล สื่อ]
║‣ /ตั้งค่า [คำสั่งเชล ตั้งค่า]
║‣ /ป้องกัน [คำสั่งเชล ป้องกัน]
║‣ /แปลภาษา [คำสั่งเชล แปลภาษา]
╠════════════════════
║‣ /เชคค่า [เชคการตั้งค่า]
╠════════════════════
║‣ เวอร์ชั่น ↓
║‣ 1.1.0
╠════════════════════
...
║‣ Add commend: <text>
║‣ Comment
║‣ Hhx1 on/off  <เปิด/ปิดข้อความต้อนรับ>
║‣ Hhx2 on/off  <เปิด/ปิดข้อความออกกลุ่ม>
║‣ Hhx3 on/off  <เปิด/ปิดข้อความคนลบ>
║‣ Mbot on/off  <เปิด/ปิดเเจ้งเตือนบอท>
║‣ M on/off  <เปิด/ปิดเเจ้งเตือนตนเอง>
...
targets = []
mid = cl.getProfile().mid
Bots = ["ucb66ed3232f6fcd92a5483e525ebd295",mid]
self = ["ucb66ed3232f6fcd92a5483e525ebd295",mid]
admin = "ucb66ed3232f6fcd92a5483e525ebd295"
admsa = "ucb66ed3232f6fcd92a5483e525ebd295"
owner = "ucb66ed3232f6fcd92a5483e525ebd295"
adminMID = "ucb66ed3232f6fcd92a5483e525ebd295"
Creator="ucb66ed3232f6fcd92a5483e525ebd295"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
    ...
    "lang":"JP",
    "comment":"AutoLike by ฟิวทีมทดลองบอท",
    "commentOn":False,
    "acommentOn":False,
    "bcommentOn":False,
    "ccommentOn":False,
...
#----------------------------------------------------------------------------
                ...
                msg.contentType = 13
                adm = 'ucb66ed3232f6fcd92a5483e525ebd295'
                msg.contentMetadata = {'mid': adm}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"Add Line http://line.me/ti/p/2lIxRozocz")
...
#==================================================
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    ki.updateProfile(profile)
            elif msg.text in ["มาบอท","#Kicker","#kicker","Kicker","kicker"]:
                        ...
                        ki1.sendText(msg.to,"[Few Bot]")
                        ki2.sendText(msg.to,"[Few Team Test Bot]")
                        ki3.sendText(msg.to,"[❦〖ⓕⓔⓦ〗☞ᵀËÄMທஇລ❂قB❂T✓]")
                        ki1.sendText(msg.to,"สวัสดี " + str(ginfo.name) + "\n\n[By:ฟิวทีมทดลองบอท]")
                        G = cl.getGroup(msg.to)
                        ginfo = cl.getGroup(msg.to)
                        G.preventJoinByTicket = True
                        ki1.updateGroup(G)
...
#==================================================
				...
				msg.contentMetadata = {'mid': mid}
				cl.sendMessage(msg)
				cl.sendText(msg.to,"[SELFBOT FEWBOT]")
            elif "ไอดี" == msg.text:
                key = msg.to
...
#========================================
                ...
                md = "􀜅􀇊􏿿 Few Team Test Bot 􀜅􀇊􏿿\n\n"
                if wait["likeOn"] == True: md+="􀔃􀄸􏿿 Auto like : on 􀜁􀄯􏿿\n"
                else:md+="􀔃􀄸􏿿 Auto like : off 􀜁􀄰􏿿\n"
                if wait["alwayRead"] == True: md+="􀔃􀄸􏿿 Read : on 􀜁􀄯􏿿\n"
                else:md+="􀔃􀄸􏿿 Read : off 􀜁􀄰􏿿\n"
                if wait["detectMention"] == True: md+="􀔃􀄸􏿿 Autorespon : on 􀜁􀄯􏿿\n"
                else:md+="􀔃􀄸􏿿 Autorespon : off 􀜁􀄰􏿿\n"
                if wait["kickMention"] == True: md+="􀔃􀄸􏿿 Autokick: on 􀜁􀄯􏿿\n"
                else:md+="􀔃􀄸􏿿 Autokick : off 􀜁􀄰􏿿\n"
                if wait["Notifed"] == True: md+="􀔃􀄸􏿿 Notifed : on 􀜁􀄯􏿿\n"
                else:md+="􀔃􀄸􏿿 Notifed : off 􀜁􀄰􏿿\n"
                if wait["Notifedbot"] == True: md+="􀔃􀄸􏿿 Notifedbot : on 􀜁􀄯􏿿\n"
                else:md+="􀔃􀄸􏿿 Notifedbot : off 􀜁􀄰􏿿\n"
                if wait["acommentOn"] == True: md+="􀔃􀄸􏿿 Hhx1 : on 􀜁􀄯􏿿\n"
                else:md+="􀔃􀄸􏿿 Hhx1 : off 􀜁􀄰􏿿\n"
                if wait["bcommentOn"] == True: md+="􀔃􀄸􏿿 Hhx2 : on 􀜁􀄯􏿿\n"
                else:md+="􀔃􀄸􏿿 Hhx2 : off 􀜁􀄰􏿿\n"
                if wait["ccommentOn"] == True: md+="􀔃􀄸􏿿 Hhx3 : on 􀜁􀄯􏿿\n"
                else:md+="􀔃􀄸􏿿 Hhx3 : off 􀜁􀄰􏿿\n"
                if wait["Protectcancl"] == True: md+="􀔃􀄸􏿿 Cancel : on 􀜁􀄯􏿿\n"
                else:md+="􀔃􀄸􏿿 Cancel : off 􀜁􀄰􏿿\n"
                if wait["winvite"] == True: md+="􀔃􀄸􏿿 Invite : on 􀜁􀄯􏿿\n"
                else:md+="􀔃􀄸􏿿 Invite : off 􀜁􀄰􏿿\n"
                if wait["pname"] == True: md+="􀔃􀄸􏿿 Namelock : on 􀜁􀄯􏿿\n"
                else:md+="􀔃􀄸􏿿 Namelock : off 􀜁􀄰􏿿\n"
                if wait["contact"] == True: md+="􀔃􀄸􏿿 Contact : on 􀜁􀄯􏿿\n"
                else: md+="􀔃􀄸􏿿 Contact : off 􀜁􀄰􏿿\n"
                if wait["autoJoin"] == True: md+="􀔃􀄸􏿿 Auto join : on 􀜁􀄯􏿿\n"
                else: md +="􀔃􀄸􏿿 Auto join : off 􀜁􀄰􏿿\n"
                if wait["autoCancel"]["on"] == True:md+="􀔃􀄸􏿿 Group cancel :" + str(wait["autoCancel"]["members"]) + " 􀜁􀄯􏿿\n"
                else: md+= "􀔃􀄸􏿿 Group cancel : off 􀜁􀄰􏿿\n"
                if wait["leaveRoom"] == True: md+="􀔃􀄸􏿿 Auto leave : on 􀜁􀄯􏿿\n"
                else: md+="􀔃􀄸􏿿 Auto leave : off 􀜁􀄰􏿿\n"
                if wait["timeline"] == True: md+="􀔃􀄸􏿿 Share : on 􀜁􀄯􏿿\n"
                else:md+="􀔃􀄸􏿿 Share : off 􀜁􀄰􏿿\n"
                if wait["clock"] == True: md+="􀔃􀄸􏿿 Clock Name : on 􀜁􀄯􏿿\n"
                else:md+="􀔃􀄸􏿿 Clock Name : off 􀜁􀄰􏿿\n"
                if wait["autoAdd"] == True: md+="􀔃􀄸􏿿 Auto add : on 􀜁􀄯􏿿\n"
                else:md+="􀔃􀄸􏿿 Auto add : off 􀜁􀄰􏿿\n"
                if wait["commentOn"] == True: md+="􀔃􀄸􏿿 Comment : on 􀜁􀄯􏿿\n"
                else:md+="􀔃􀄸􏿿 Comment : off 􀜁􀄰􏿿\n"
                if wait["Backup"] == True: md+="􀔃􀄸􏿿 Backup : on 􀜁􀄯􏿿\n"
                else:md+="􀔃􀄸􏿿 Backup : off 􀜁􀄰􏿿\n"
                if wait["qr"] == True: md+="􀔃􀄸i􏿿 Protect QR : on 􀜁􀄯􏿿\n"
                else:md+="􀔃􀄸􏿿 Protect QR : off 􀜁􀄰􏿿\n"
...
#==============================================================================#
            ...
            elif "Fewmic " in msg.text:
                cmd = msg.text.replace("Fewmic ","")
                if cmd == "on":
                    if mimic["status"] == False:
                        mimic["status"] = True
...
#==============================================================================#
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
                                    ...
                                    raise e
            elif "vdo @" in msg.text:
                print "[Command]dp executing"
                _name = msg.text.replace("vdo @","")
                _nametarget = _name.rstrip('  ')
                gs = cl.getGroup(msg.to)
                targets = []
                for g in gs.members:
            ...
            elif "Fh2url @" in msg.text:
                print "[Command]cover executing"
                _name = msg.text.replace("Fh2url @","")    
                _nametarget = _name.rstrip('  ')
                gs = cl.getGroup(msg.to)
                targets = []
                for g in gs.members:
       ...
       #-------------Fungsi Respon Start---------------------#
        ...
        if op.type == 25:
            ...
            if msg.text.lower() in ["few tag"]:
                ...
                cnt = Message()
                cnt.text = "FEW TAG DONE : " + str(jml) +  " Members"
                cnt.to = msg.to
                cl.sendMessage(cnt)
        ...
        if op.type == 26:
            ...
            if msg.text.lower() in ["1123"]:
                ...
                if msg.to not in wait2['readPoint']:
                    ...
                    if msg.to in wait2['readPoint']:
                        if wait2["ROM"][msg.to].items() == []:
                             cl.sendText(msg.to, "SELFBOT FEW BOT\n\nLurkers:\nNone")
                        else:
                            chiya = []
                            for rom in wait2["ROM"][msg.to].items():
                                chiya.append(rom[1])
